/**
 * Binance API Edge Proxy for Netlify
 * Ejecuta en la red Edge global de Netlify (Deno runtime, 0ms cold start, ultra-rápido).
...
export default async function handler(request, context) {
  ...
  try {
    ...
    return new Response(JSON.stringify({ code: -1, msg: 'Error en Netlify Proxy: ' + err.message }), {
      status: 502,
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        ...corsHeaders,
